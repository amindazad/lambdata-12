...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Readability, its very important to have codes that comply with PEP8 guidlines as 
  programmers spend alot of time just reading code.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  We can use docker to create immages on the cloud and have all your computers save 
  on immages build on cloud using containers. At its heart lies Docker, a platform that allows users to easily pack, distribute, and manage applications within containers. In other words, It is an open-source project that automates the deployment of applications inside software containers.
